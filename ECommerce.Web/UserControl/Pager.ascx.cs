...
namespace ECommerce.Web.UserControl
{
    public partial class Pager : System.Web.UI.UserControl
    {
        ...
        public void GetDataBind(string controlType, string controlId, string pSql, int pNum, int pSiz, string sort, string rowNumName, string url, string msg = "")
        {
            int rCount;//记录总数
            int pCount;//页总数
            ...
            if (rCount <= 0&&!string.IsNullOrEmpty(msg))
            {
                ((Literal) (Parent.FindControl("litMsg"))).Text = msg;
                //((Repeater)(Parent.FindControl(controlId))).DataSource = null;
                //Parent.FindControl(controlId).DataBind();
            }
        ...
        public void GetDataBindMySql(string controlType, string controlId, string pSql, int pNum, int pSiz, string sort, string url)
        {
            int rCount;//记录总数
            int pCount;//页总数
