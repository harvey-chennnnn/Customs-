...
namespace ECommerce.Web.Manage.DeviceMonitor {
    public partial class DeviceDesList : UI.WebPage {
        ...
        private void BindData(bool isFirstPage) {
            ...
            //分页方法
            Pager1.GetDataBind("Repeater", "rptListWork", sql, pageNum, pageSize, "", "rownum", "DeviceDesList.aspx?name=" + name + "&loaner=" + puser + "&");
            #endregion
        }
