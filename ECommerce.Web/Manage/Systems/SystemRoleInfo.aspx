...
<body class="pd">
    <form id="form1" runat="server">
        ...
        <p class="search-box clearfix">
            <span>角色名称：</span>
            <input type="text" runat="server" id="txtRoleName" placeholder="角色名称" />
            <asp:LinkButton ID="btnSearchRole" runat="server" CssClass="search-btn" OnClick="btnSearchRole_Click" Text="搜索" />
        </p>
